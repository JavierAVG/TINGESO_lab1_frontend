...
import savingsAccountService from "../services/savingsAccount.service";
...
const LoanEvaluation = () => {
    ...
    useEffect(() => {
        ...
        loanService
            .get(id)
            .then((loan) => {
                setIdClient(loan.data.idClient);
    ...
    return (
        ...
        >
            ...
            <Button
                ...
                type="submit"
                onClick={() => {
                    setState("Documentation pending")
                    alert("Client may fix loan request")
                }}
            >
            ...
            <Button
                ...
                type="submit"
                onClick={() => {
                    setState("Pre-approved")
                    alert("Current loan pre-approved")
                }}
            >
                Pre-Approve
            </Button>
